...
root_agent = Agent(
    ...
    instruction=(
        ...
        "Premier League, Champions League, La Liga, Bundesliga, Serie A, Ligue 1, AFCON, "
        "Copa América, MLS, Saudi Pro League, Eredivisie, and more. "
        "If a user asks for a league not in your map, the system will search for it automatically.\n\n"
